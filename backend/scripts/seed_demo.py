...
COACHES_TEMPLATES = [
    ...
    },
    {
        ...
        "templates": [
            {
                "nombre": "Hora de Poder (Tom Ferry)",
                "descripcion": "Desafio 90 dias: 6 conversaciones reales por dia.",
                "mercado": "USA",
                "es_default_inmobiliaria": False,
                "bloques": [
                    {
                        "nombre": "Mentalidad Matinal",
                    ...
                    },
                    {
                        ...
                        "descripcion": "60 minutos de prospeccion intensa. Meta: 6 conversaciones reales.",
                    ...
                    },
                    {
                        ...
                        "descripcion": "45 min de seguimiento a leads activos del CRM. Cadencia: dia 1, dia 3, dia 7.",
                        "hora_inicio": time(9, 15), "hora_fin": time(10, 0),
                        "color": "#f59e0b", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Seguimientos", "metrica_meta": 10,
                    },
                    {
                        "nombre": "Prospeccion de Zona",
                        "descripcion": "15 min de prospeccion en zona propia (puerta a puerta, vecinos, autorizaciones vencidas).",
                        "hora_inicio": time(10, 0), "hora_fin": time(10, 15),
                        "color": "#10b981", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Contactos en zona", "metrica_meta": 3,
                    },
                    {
                        "nombre": "Visitas y Presentaciones",
                        "descripcion": "Presentaciones de tasacion, recorridas, jornadas de puertas abiertas, reuniones con compradores y vendedores.",
                    ...
                    },
                    {
                        ...
                        "descripcion": "Actualizar CRM, armar agenda de mañana, revisar metricas del dia.",
    ...
    },
    {
        ...
        "templates": [
            {
                "nombre": "Prospeccion Clasica (Mike Ferry)",
                "descripcion": "3h de prospeccion a la mañana, ininterrumpidas. Scripts estructurados.",
                "mercado": "USA",
                "es_default_inmobiliaria": False,
                "bloques": [
                    {
                        "nombre": "Rutina Matinal",
                    ...
                    {
                        "nombre": "Bloque de Prospeccion",
                        "descripcion": "3 horas seguidas de llamados con scripts. Pomodoro: 25min activo, 5min pausa. SIN interrupciones.",
                    ...
                    {
                        "nombre": "Seguimiento de Leads",
                        "descripcion": "Re-llamar leads, agendar citas, manejo de objeciones.",
                        "hora_inicio": time(11, 0), "hora_fin": time(12, 0),
                        "color": "#f59e0b", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Citas agendadas", "metrica_meta": 2,
                    },
                    {
                        "nombre": "Citas y Visitas",
                        "descripcion": "Presentaciones de tasacion, consultas con compradores, visitas a propiedades.",
                    ...
                    },
                    {
                        ...
                        "descripcion": "Papeleria, CRM, agenda del dia siguiente.",
    ...
    },
    {
        ...
        "templates": [
            {
                "nombre": "Trabajo por Referidos (Buffini)",
                "descripcion": "Basado en la cartera de contactos. Sin llamadas frias. Llamadas + Notas + Visitas con atencion.",
                "mercado": "USA",
                "es_default_inmobiliaria": False,
                "bloques": [
                    {
                        "nombre": "Rutina Matinal",
                        "descripcion": "Reflexion + planificacion. Repaso de la cartera del dia.",
                        "hora_inicio": time(7, 30), "hora_fin": time(8, 30),
                        "color": "#a78bfa", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.checkbox, "metrica_label": None, "metrica_meta": 0,
                    },
                    {
                        "nombre": "Llamadas a Cartera",
                        "descripcion": "Llamados calidos a la cartera de contactos. Sin scripts agresivos, charla genuina de seguimiento.",
                        "hora_inicio": time(9, 0), "hora_fin": time(10, 30),
                        "color": "#ef4444", "es_money_block": True,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Llamadas a cartera", "metrica_meta": 5,
                    },
                    {
                        "nombre": "Notas Personales",
                        "descripcion": "Escribir 3-5 notas a mano: agradecimientos, felicitaciones, recordatorios. El diferenciador clave del sistema.",
                        "hora_inicio": time(10, 30), "hora_fin": time(11, 0),
                        "color": "#f59e0b", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Notas escritas", "metrica_meta": 5,
                    },
                    {
                        "nombre": "Visitas con Atencion",
                        "descripcion": "Visitas cortas a 2-3 contactos calidos con un detalle (cafe, planta, alfajor). 5 minutos cada una.",
                        "hora_inicio": time(11, 0), "hora_fin": time(12, 30),
                        "color": "#10b981", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Visitas con atencion", "metrica_meta": 3,
                    },
                    {
                        "nombre": "Generacion de Negocio",
                        "descripcion": "Trabajo con compradores y vendedores actuales, visitas a propiedades, presentaciones.",
                        "hora_inicio": time(13, 30), "hora_fin": time(17, 0),
                        "color": "#22c55e", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.checkbox, "metrica_label": None, "metrica_meta": 0,
                    },
                    {
                        "nombre": "Actualizacion del CRM",
                        "descripcion": "Cargar en el CRM cada interaccion con la cartera del dia.",
    ...
    },
    {
        ...
        "templates": [
            {
                "nombre": "Actividades Que Generan Plata (Workman)",
                "descripcion": "Bloques de tiempo enfocados en actividades que generan ingresos directos.",
                "mercado": "USA",
                "es_default_inmobiliaria": False,
                "bloques": [
                    {
                        "nombre": "Foto del Mercado",
                        "descripcion": "Revisar portales, listings nuevos en zona, precios que se mueven.",
                        "hora_inicio": time(8, 0), "hora_fin": time(8, 45),
                        "color": "#94a3b8", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.checkbox, "metrica_label": None, "metrica_meta": 0,
                    },
                    {
                        "nombre": "Actividades Que Generan Plata",
                        "descripcion": "El bloque sagrado. Solo actividades que generan ingreso: captacion de leads, citas con vendedores, negociacion de contratos.",
                        "hora_inicio": time(9, 0), "hora_fin": time(11, 0),
                        "color": "#ef4444", "es_money_block": True,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Contactos productivos", "metrica_meta": 15,
                    },
                    {
                        "nombre": "Formacion",
                        "descripcion": "30-60 min de capacitacion: scripts, role-play, lectura, podcast del rubro.",
                    ...
                    },
                    {
                        ...
                        "descripcion": "Reuniones con clientes activos, visitas a propiedades, presentaciones, negociaciones.",
                        "hora_inicio": time(13, 0), "hora_fin": time(16, 30),
                        "color": "#22c55e", "es_money_block": False,
                        "metrica_tipo": MetricaTipo.cantidad, "metrica_label": "Reuniones", "metrica_meta": 2,
                    },
                    {
                        "nombre": "Sistemas y Procesos",
